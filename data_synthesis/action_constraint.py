...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_file", type=str, default='dataset/GLM_action_constraint.json', help="Output file path (default 'dataset/GLM_action_constraint.json')")
    args = parser.parse_args()

    with open('dataset/action_constraint.json', 'r') as input_file:
