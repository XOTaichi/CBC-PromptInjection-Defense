...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_file", type=str, default='sft_dataset/raw/GLM_constraint_constraint.json', help="Output file path (default 'sft_dataset/raw/GLM_constraint_constraint.json')")
    args = parser.parse_args()

    with open('sft_dataset/raw/constraint_constraint.json', 'r') as input_file:
